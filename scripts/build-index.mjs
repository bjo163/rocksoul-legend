...
const taxonomy=JSON.parse(fs.readFileSync(path.join(root,"taxonomy/event-types.json"),"utf8"));
const index={schema_version:"0.1",counts:{
  canonical_events:count("data/events"),
...
console.log("LEGEND index generated");
